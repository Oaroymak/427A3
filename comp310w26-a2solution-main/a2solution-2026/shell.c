...
int main(int argc, char *argv[]) {
    // A3: The spec requires this as the sole startup message.
    // The A2 version string is removed because it would appear as an extra
    // line in the output and cause test-case comparisons to fail.
